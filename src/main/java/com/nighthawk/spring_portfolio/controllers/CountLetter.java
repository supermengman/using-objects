...
public class CountLetter {
    ...
    @GetMapping("/countletter")
    // @RequestParam handles variables binding to frontend, defaults, etc
    public String countLetter(@RequestParam(name="name", required=false, defaultValue="bruh") String name, Model model) {

        // model attributes are visible to Thymeleaf when HTML is "pre-processed"
        model.addAttribute("value", name.length());
